...
export function AIWaveBackground() {
    ...
    useEffect(() => {
      ...
      `,
        ...
        function createInstancedMaterial() {
            // Bright, highly glowing luxury purple scheme requested by user
            const baseCol = new THREE.Color("#7c3aed"); // Purple
            const emisCol = new THREE.Color("#c4b5fd"); // Brighter Violet
            ...
            return new THREE.ShaderMaterial({
                ...
                uniforms: {
                    ...
                    uBaseEmissive: { value: 0.35 }, // Dramatically increased base glow
    ...
    return (
        <div
            ref={waveRef}
            id="waveCanvas"
            className="absolute inset-x-0 bottom-0 top-[20%] z-0 pointer-events-none"
            style={{
