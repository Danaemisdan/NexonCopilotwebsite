...
export default function WaitlistExperience(): ReactElement {
    ...
    return (
        <main className="relative min-h-screen overflow-hidden bg-black w-full flex items-center justify-center font-sans">
            {/* Three.js Background */}
                                ...
                                <>
                                    <div className="mb-8 text-center flex flex-col items-center">
                                        ...
                                        <p className="text-white/70 text-base leading-relaxed font-light">
                                            ...
                                            <br />
                                            AI workforce platform launching soon.
                                        </p>
                                    </div>
                                    ...
                                    <form onSubmit={handleSubmit} className="mb-6">
                                        <div className="flex gap-3">
                                            <Input
                                                ...
                                                required
                                                className="flex-1 bg-black/40 border-white/20 text-white placeholder:text-white/50 focus:border-white/40 focus:ring-white/20 h-13 rounded-xl backdrop-blur-sm px-4"
                                            />
                                            <Button
                                                type="submit"
                                                className="h-13 px-8 bg-[#7c3aed] hover:bg-[#6d28d9] text-white font-medium rounded-xl transition-all duration-300 hover:shadow-[0_0_20px_rgba(124,58,237,0.4)] border-0"
                                            >
                                                Join Now
                                            </Button>
                                        </div>
                                    ...
                                    <div className="flex items-center justify-center gap-6 text-center mt-10">
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <div className="text-[10px] text-white/50 uppercase tracking-widest mt-1"> minutes </div>
                                        </div>
                                        <div className="text-white/20 text-3xl font-light">| </div>
                                        <div>
                                            <div className="text-3xl font-light text-white"> {timeLeft.seconds} </div>
                                            <div className="text-[10px] text-white/50 uppercase tracking-widest mt-1"> seconds </div>
                                        </div>
                                    </div>
                                </>
                            ) : (
                                <div className="text-center py-4">
                                    <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-primary/30 to-purple-500/30 flex items-center justify-center border border-primary/40">
                                        <svg
                                    ...
                                    <p className="text-white/90 text-sm drop-shadow-md font-light">
                                        We'll notify you when we open access. Thanks for joining the revolution.
                                    </p>
                                </div>
                            )}
                        </div>
